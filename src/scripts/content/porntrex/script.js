/**
 * @description - Dissenter - PornTrex content script
 */
var GDPorntrex = function() {
    //Global scope
    var scope = this;
    ...
    function fetchElements() {
        ...
        var topBar = document.querySelector('#tab_video_info > div > div > div.videodesc.item > div');
